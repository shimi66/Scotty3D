...
Test test_a1_task7_index("a1.task7.index", []() {
	...
	// std::cout << " testing fb " << fb.sample_pattern.centers_and_weights.size() << std::endl;
...
Test test_a1_task7_index_4("a1.task7.index_4", []() {
	...
	//this is a terrible sample pattern, but it does have an odd number of sample locations:
	SamplePattern pattern(SamplePattern::CustomBit | 1234, "just some test sample pattern", std::vector< Vec3 >{
		Vec3(0.1f, 0.1f, 0.125f),
		Vec3(0.2f, 0.2f, 0.125f),
		Vec3(0.2f, 0.3f, 0.125f),
		Vec3(0.3f, 0.2f, 0.125f),
		Vec3(0.3f, 0.3f, 0.125f),
		Vec3(0.9f, 0.1f, 0.125f),
		Vec3(0.1f, 0.9f, 0.125f),
		Vec3(0.0f, 0.9f, 0.125f)
	});
...
Test test_a1_task7_resolve_2("a1.task7.resolve_2", []() {
	...
	if (resolved.at(0,0) != Spectrum(0.0f, 0.0f, 0.0f)
	 || resolved.at(0,1) != Spectrum(0.0f, 0.0f, 0.0f)
	 || resolved.at(1,1) != Spectrum(0.0f, 0.0f, 0.0f)
	 || resolved.at(1,0) != Spectrum(0.0f, 0.0f, 0.0f) ) {
